...
<head>
  ...
  <title>Data Pendaftaran | Tamrinuttulab</title>
  <!-- Favicons -->
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Data Pendafataran Santri Baru
        <!-- <small>advanced tables</small> -->
      </h1>
      <ol class="breadcrumb">
        <li class="active fa fa-dashboard">Home</li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="box-body">
            <div class="box-header">
              <a class="btn btn-success btn-flat" href="<?php echo base_url().'admin/siswa'?>"><span class="fa fa-print"></span> Laporan</a>
            </div>
                    ...
                    <div class="modal-body">
                      ...
                      <div class="form-group">
                        <label for="inputUserName" class="col-sm-4 control-label">No Peserta</label>
                          <div class="col-sm-7">
                            <input type="text" name="xnoPeserta" class="form-control" value="<?php echo $no_peserta;?>" id="inputUserName" disabled >
                          </div>
                      </div>
                      <div class="form-group">
                        <label for="inputUserName" class="col-sm-4 control-label">NISN</label>
                          <div class="col-sm-7">
                            <input type="text" name="xnisn" class="form-control" value="<?php echo $nisn;?>" id="inputUserName" placeholder="NISN">
                          </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="inputUserName" class="col-sm-4 control-label">Nama Sekolah</label>
                          <div class="col-sm-7">
                            <input type="text" name="xasalSekolah" class="form-control" value="<?php echo $asal_sekolah;?>" id="inputUserName" placeholder="Asal Sekolah">
                          </div>
                      </div>
                      <div class="form-group">
                        <label for="inputUserName" class="col-sm-4 control-label">Tingkat Sekolah</label>
                          <div class="col-sm-7">
                          <select class="form-control" name="xsekolahTujuan" >
                              <option value="<?php echo $sekolah_tujuan;?>"><?php echo $sekolah_tujuan;?></option>
                              <?php if($sekolah_tujuan == "SD"): ?>
                                <option value="PAUD">PAUD</option>
                                <option value="TK">TK</option>
                                <option value="SMP">SMP</option>
                                <option value="SMA">SMA</option>
                                <option value="Lulus SMA">Lulus SMA</option>
                              <?php elseif($sekolah_tujuan == "SMP"): ?>
                                <option value="PAUD">PAUD</option>
                                <option value="TK">TK</option>
                                <option value="SD">SD</option>
                                <option value="SMA">SMA</option>
                                <option value="Lulus SMA">Lulus SMA</option>
                              <?php elseif($sekolah_tujuan == "SMA"): ?>
                                <option value="PAUD">PAUD</option>
                                <option value="TK">TK</option>
                                <option value="SD">SD</option>
                                <option value="SMP">SMP</option>
                                <option value="Lulus SMA">Lulus SMA</option>
                              <?php elseif($sekolah_tujuan == "Lulus SMA"): ?>
                                <option value="PAUD">PAUD</option>
                                <option value="TK">TK</option>
                                <option value="SD">SD</option>
                                <option value="SMP">SMP</option>
                                <option value="SMA">SMA</option>
                              <?php elseif($sekolah_tujuan == "PAUD"): ?>
                                <option value="TK">TK</option>
                                <option value="SD">SD</option>
                                <option value="SMP">SMP</option>
                                <option value="SMA">SMA</option>
                                <option value="Lulus SMA">Lulus SMA</option>
                              <?php elseif($sekolah_tujuan == "TK"): ?>
                                <option value="PAUD">PAUD</option>
                                <option value="SD">SD</option>
                                <option value="SMP">SMP</option>
                                <option value="SMA">SMA</option>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id_peserta;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/Data/hapus_daftar'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
							       <input type="hidden" name="xkode" value="<?php echo $id_peserta;?>"/>

      ...
      <div class="row">
        ...
        <div class="box-body">
            <div class="box-header">
              <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#modalAdd"><span class="fa fa-user-plus"></span> Add Guru</a>
            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="modalAddLabel">Add Guru</h4>
                    </div>
                    ...
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xnama" class="form-control" id="inputUserName" placeholder="Nama Guru" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xtingkat" class="form-control" id="inputUserName" placeholder="Tingkat" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="inputUserName" class="col-sm-4 control-label" style="font-weight: lighter; font-style:italic;">*Saran ukuran rasio foto 1:1 contoh 600x600pixel</label>
                                    </div>
...
<?php
          ...
          ?>
        <div class="modal fade" id="ModalEdit<?php echo $id_guru;?>" tabindex="-1" role="dialog" aria-labelledby="modalAddLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="modalAddLabel">Edit Data Guru</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'admin/Guru/update_guru'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                      <input type="hidden" name="kode" value="<?php echo $id_guru;?>"/>
                      <div class="form-group">
                        <label for="inputUserName" class="col-sm-4 control-label">Nama Guru</label>
                          <div class="col-sm-7">
                            <input type="text" name="xnama" class="form-control" value="<?php echo $nama_guru;?>" id="inputUserName" required>
                          </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                          <label for="inputEmail3" class="col-sm-4 control-label">Tingkat</label>
                          <div class="col-sm-7">
                              <input type="text" name="xtingkat" class="form-control" value="<?php echo $tingkat;?>" id="inputUserName" placeholder="Tingkat" required>
                          </div>
                      </div>
                      <div class="form-group">
                        <label for="inputUserName" class="col-sm-4 control-label">Foto</label>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id_guru;?>" tabindex="-1" role="dialog" aria-labelledby="modalAddLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="modalAddLabel">Hapus Data Guru</h4>
                    </div>

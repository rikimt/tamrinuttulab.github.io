...
<head>
  ...
  <title>Inbox | Tamrinuttulab</title>
    <!-- Favicons -->
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a class="active" href="<?php echo base_url().'admin/Prestasi'?>"><i class="fa fa-trophy"></i> <span>Prestasi</span></a></li>
            ...
            <table id="example1" class="table table-striped" style="font-size:12px;">
              ...
              <?php
                  $no=0;
                    ...
                    $inbox_subject=$i['inbox_subject']; 
                    $inbox_pesan=$i['inbox_pesan']; 
                    $inbox_tanggal=$i['inbox_tanggal']; 
                  ?>
              <tr>
                <td><?php echo $inbox_tanggal;?></td>
                <td><?php echo $inbox_nama;?></td>
                <td><?php echo $inbox_email;?></td>
                <td><?php echo $inbox_subject;?></td>
                <td><?php echo $inbox_pesan;?></td>
...
<?php
        ...
        <div class="modal fade" id="ModalHapus<?php echo $inbox_id;?>" tabindex="-1" role="dialog" aria-labelledby="modalAddLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="modalAddLabel">Hapus Pesan</h4>
                    </div>
